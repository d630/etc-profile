...
ProfileRcBaseUser () {
    ...
    AUDIO_PLAYER_OPTS=--no-video\|--af-add=volume=replaygain-track;
    ...
    X_AUDIO_PLAYER_OPTS=--profile=pseudo-gui\|--no-video\|--af-add=volume=replaygain-track\|--autofit=50%x50%\|--no-stop-screensaver;
